...
from sociopulator.srv import Gripper
from sociopulator.srv import GripperRequest
from sociopulator.srv import GripperResponse
from sociopulator.msg import GripperContact
...
def main():
    ...
    s = rospy.Service('/scara/activate_vacuum_gripper', Gripper, gripper.callback_service_on_request)
    rospy.loginfo( '\033[94m' + " >>> Vacuum Gripper Activation Service Ready." + '\033[0m')
    
    rospy.Subscriber(gripper._logical_camera_topic_name, GripperContact, gripper.callback_topic_subscription)
